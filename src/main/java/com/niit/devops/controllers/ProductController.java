package com.niit.devops.controllers;
...
import com.niit.devops.service.CategoryService;
import com.niit.devops.service.ProductService;
...
public String saveOrUpdateProduct(@Valid @ModelAttribute(name="product") Product product,BindingResult result){
	...
	Path path=Paths.get
("C:/Users/Admin/workspace/devops/src/main/webapp/WEB-INF/resources/images/"+product.getId()+".png");
	try {
